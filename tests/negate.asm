...
# was:	mv	_let_x0_10_, x10
	li	x10, 3
# was:	li	_int_neg_24_, 3
	sub	x11, x0, x10
# was:	sub	_divide_L_22_, x0, _int_neg_24_
	li	x10, 2
...
# was:	div	_eq_L_20_, _divide_L_22_, _divide_R_23_
	li	x11, 2
# was:	li	_int_neg_26_, 2
	sub	x11, x0, x11
# was:	sub	_eq_R_21_, x0, _int_neg_26_
	li	x12, 0
# was:	li	_arg_19_, 0
...
# was:	li	_divide_L_32_, 3
	li	x11, 2
# was:	li	_int_neg_34_, 2
	sub	x11, x0, x11
# was:	sub	_divide_R_33_, x0, _int_neg_34_
...
# was:	div	_eq_L_30_, _divide_L_32_, _divide_R_33_
	li	x11, 2
# was:	li	_int_neg_36_, 2
	sub	x11, x0, x11
# was:	sub	_eq_R_31_, x0, _int_neg_36_
	li	x12, 0
# was:	li	_arg_29_, 0
...
# was:	mv	_let_x2_28_, x10
	li	x10, 3
# was:	li	_int_neg_44_, 3
	sub	x10, x0, x10
# was:	sub	_divide_L_42_, x0, _int_neg_44_
	li	x11, 2
# was:	li	_int_neg_45_, 2
	sub	x11, x0, x11
# was:	sub	_divide_R_43_, x0, _int_neg_45_
...
# 	mv	_bool_not_55_,_let_x1_18_
	xori	x11, x18, 1
# was:	xori	_and_R_54_, _bool_not_55_, 1
...
# 	mv	_bool_not_58_,_let_x2_28_
	xori	x11, x20, 1
# was:	xori	_and_R_52_, _bool_not_58_, 1
	beq	x11, x0, l.false_59_
