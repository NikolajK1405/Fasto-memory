...
l.loop_beg_27_:
	bge	x12, x10, l.loop_end_28_
# was:	bge	_ind_var_25_, _size_24_, l.loop_end_28_
	lw	x13, 0(x19)
# was:	lw	_tmp_26_, 0(_arr_23_)
	addi	x19, x19, 4
# was:	addi	_arr_23_, _arr_23_, 4
# 	mv	_times_L_30_,_let_y_22_
# 	mv	_times_R_31_,_tmp_26_
	mul	x11, x11, x13
# was:	mul	_fun_arg_res_29_, _times_L_30_, _times_R_31_
...
l.loop_end_28_:
	mv	x10, x11
# was:	mv	_tmp_33_, _let_y_22_
# 	mv	_let_t_32_,_tmp_33_
# 	mv	x10,_let_t_32_
	jal	p.putint
