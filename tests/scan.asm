...
# was:	li	_acc_17_, 0
	lw	x18, 0(x20)
# was:	lw	_size_19_, 0(_arr_16_)
	mv	x19, x3
# was:	mv	_let_b_15_, x3
	slli	x11, x18, 2
# was:	slli	_tmp_24_, _size_19_, 2
	addi	x11, x11, 4
# was:	addi	_tmp_24_, _tmp_24_, 4
	add	x3, x3, x11
# was:	add	x3, x3, _tmp_24_
	sw	x18, 0(x19)
# was:	sw	_size_19_, 0(_let_b_15_)
	addi	x20, x20, 4
# was:	addi	_arr_16_, _arr_16_, 4
	addi	x21, x19, 4
# was:	addi	_elm_18_, _let_b_15_, 4
	mv	x22, x0
# was:	mv	_ind_var_20_, x0
l.loop_beg_22_:
	bge	x22, x18, l.loop_end_23_
# was:	bge	_ind_var_20_, _size_19_, l.loop_end_23_
	lw	x11, 0(x20)
# was:	lw	_tmp_21_, 0(_arr_16_)
	addi	x20, x20, 4
# was:	addi	_arr_16_, _arr_16_, 4
# 	mv	x10,_acc_17_
# 	mv	x11,_tmp_21_
...
# 	mv	_tmp_25_,x10
# 	mv	_acc_17_,_tmp_25_
	sw	x10, 0(x21)
# was:	sw	_acc_17_, 0(_elm_18_)
	addi	x21, x21, 4
# was:	addi	_elm_18_, _elm_18_, 4
	addi	x22, x22, 1
